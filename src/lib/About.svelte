<div class="page">
  ...
  <h1>About</h1>
  <p class="sub">A number-line rounding drill built for teachers and their students.</p>
  ...
  <section class="card">
    ...
    <p>
      Rounding on a Number Line is a project from
    ...
    <figure class="photo">
      <img src="/2026participants.jpg" alt="Participants of the 2026 EdTech-a-thon" />
  ...
  <section class="card">
    ...
    <a class="btn-dark" href="mailto:directors@teacher.dev?subject=lines%20feedback">Email directors@teacher.dev</a>
  </section>
</div>

<style>
  .page { max-width: 46rem; margin: 0 auto; padding: 1.5rem 1.25rem 2rem; }
  ...
  .titlerow { display: flex; align-items: center; gap: 0.75rem; margin-bottom: 0.5rem; }
  ...
  /* A snapshot pinned to the page, like on the other teacher.dev tools. */
  .photo {
    max-width: 32rem;
  ...
  .photo img { display: block; width: 100%; background: var(--bg); }
  figcaption {
    padding-top: 1rem;
    text-align: center;
    font-size: 1.15rem;
